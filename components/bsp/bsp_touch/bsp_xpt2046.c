...
static esp_err_t xpt2046_swap_xy(esp_lcd_touch_handle_t tp, bool swap);
static esp_err_t xpt2046_mirror_x(esp_lcd_touch_handle_t tp, bool mirror);
static esp_err_t xpt2046_mirror_y(esp_lcd_touch_handle_t tp, bool mirror);
static esp_err_t xpt2046_enter_sleep(esp_lcd_touch_handle_t tp);
static esp_err_t xpt2046_exit_sleep(esp_lcd_touch_handle_t tp);
                                        ...
                                        esp_lcd_touch_handle_t *out_touch)
{
    ...
    handle->set_swap_xy = xpt2046_swap_xy;
    handle->set_mirror_x = xpt2046_mirror_x;
    handle->set_mirror_y = xpt2046_mirror_y;
    handle->enter_sleep = xpt2046_enter_sleep;
    handle->exit_sleep = xpt2046_exit_sleep;
